package com.kartikaymahajan.projectprogress.firebase
...
import com.kartikaymahajan.projectprogress.activities.*
...
class FirestoreClass {
    ...
    fun assignMemberToBoard(activity: MembersActivity, board: Board, user: User) {
        ...
        assignedToHashMap[Constant.ASSIGNED_TO] = board.assignedTo
