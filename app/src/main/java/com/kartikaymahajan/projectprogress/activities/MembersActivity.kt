...
import com.kartikaymahajan.projectprogress.adapters.MemberListItemsAdapter
...
class MembersActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(Constant.BOARD_DETAIL)) {
            mBoardDetails = intent.getParcelableExtra<Board>(Constant.BOARD_DETAIL)!!
        }
    ...
    private inner class SendNotificationToUserAsyncTask(val boardName: String, val token: String) :
        ...
        override fun doInBackground(vararg params: Any): String {
            ...
            try {
                val url = URL(Constant.FCM_BASE_URL) // Base Url
