...
import com.kartikaymahajan.projectprogress.adapters.TaskListItemsAdapter
import com.kartikaymahajan.projectprogress.firebase.FirestoreClass
import com.kartikaymahajan.projectprogress.models.Board
import com.kartikaymahajan.projectprogress.models.Card
import com.kartikaymahajan.projectprogress.models.Task
import com.kartikaymahajan.projectprogress.models.User
...
class TaskListActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(Constant.DOCUMENT_ID)) {
            mBoardDocumentId = intent.getStringExtra(Constant.DOCUMENT_ID)!!
        }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.action_members -> {
                ...
                intent.putExtra(Constant.BOARD_DETAIL, mBoardDetails)
    ...
    fun cardDetails(taskListPosition: Int, cardPosition: Int) {
        ...
        intent.putExtra(Constant.BOARD_DETAIL, mBoardDetails)
        intent.putExtra(Constant.TASK_LIST_ITEM_POSITION, taskListPosition)
        intent.putExtra(Constant.CARD_LIST_ITEM_POSITION, cardPosition)
        intent.putExtra(Constant.BOARD_MEMBERS_LIST, mAssignedMembersDetailList)
