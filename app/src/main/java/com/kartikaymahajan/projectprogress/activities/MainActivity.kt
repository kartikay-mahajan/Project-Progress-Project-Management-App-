...
import com.kartikaymahajan.projectprogress.adapters.BoardItemsAdapter
...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSharedPreferences =
            this.getSharedPreferences(Constant.PROJECT_PROGRESS_PREFERENCES, Context.MODE_PRIVATE)
